...
class EdgeTPUEngine(Engine):
    ...
    def detect_image(self, image=None, image_file=None, threshold=TF_THRESHOLD):
        ...
        if len(interesting_objs):
            ...
            self.draw_object(ImageDraw.Draw(image), best_obj.bbox, self._labels.get(obj.id, obj.id), best_obj.score)
...
if __name__ == '__main__':
    e = EdgeTPUEngine("models/ssd_mobilenet_v2_coco_quant_postprocess_edgetpu.tflite", "models/coco_labels.txt")
